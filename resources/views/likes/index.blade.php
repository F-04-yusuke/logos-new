                        ...
                        @forelse ($likedAnalyses as $analysis)
                            <div class="p-4 bg-gray-50 dark:bg-[#131314] rounded-lg border border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-500 mb-1">公開先トピック: <a href="{{ route('topics.show', $analysis->topic_id) }}" class="text-blue-500 hover:underline font-bold">{{ $analysis->topic->title }}</a></p>
                                ...
                                <div class="flex items-center gap-3 shrink-0">
                                    <a href="{{ route('analyses.show', $analysis) }}" class="text-xs font-bold text-blue-500 hover:text-blue-700">もっと見る ▶</a>
                                </div>
                            </div>
                        @empty
