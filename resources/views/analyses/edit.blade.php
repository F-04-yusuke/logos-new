        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-[#1e1f20] rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-800">
                ...
                <div class="p-6 bg-white dark:bg-[#131314]">
                    <form method="POST" action="{{ route('analyses.update', $analysis) }}" id="edit-analysis-form">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="title" value="{{ old('title', $analysis->title) }}" class="w-full rounded-md bg-gray-50 border-gray-300 dark:bg-[#1e1f20] dark:border-gray-700 dark:text-white text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500" required>
                        </div>

                        <div class="mb-2 p-4 bg-gray-50 dark:bg-[#1e1f20] rounded border border-gray-200 dark:border-gray-700">
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-bold mb-2">💡 ツール種別: <span class="text-blue-500">{{ strtoupper($analysis->type) }}</span></p>
                ...
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-[#1e1f20]">
                    ...
                    <button type="submit" form="edit-analysis-form" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md text-sm transition-colors">更新する</button>
                </div>
